import 'package:ecom_store/model/product_model.dart';
...
class _ProductState extends State<Product> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: FutureBuilder(
        future: ProductServices.getProduct(),
          ...
          if (snapshot.connectionState == ConnectionState.done) {
            return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                final productData = snapshot.data!.product![index];
                return Container(
                  height: 200,
                  width: 360,
                  color: Colors.blue,
